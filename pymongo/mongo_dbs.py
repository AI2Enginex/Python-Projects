...
if __name__ == '__main__':
    ...
    dbr.update_record(scope='many', key="name", queries='Vibhor', values="Engineer")
    ...
    # dbr.agg_func2(operation="$group", field_name1="_id", field_name2="$user", col1="$comments",
